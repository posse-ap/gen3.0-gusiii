...
class Exam
{
    ...
    public function Case2()
    {
        ...
        $sql = 'SELECT MIN(old) from employees';
        $ret = $db->query($sql)->fetchColumn();
    ...
    public function Case3()
    {
        ...
        $sql = 'SELECT MAX(amount) as maximum FROM salary WHERE year=2020 AND deleted_at is null';
        $ret = $db->query($sql)->fetchColumn();
    ...
    public function Case4()
    {
        ...
        $sql = 'SELECT dept_name from depts WHERE id = (SELECT dept_id from employees where deleted_at is null group by dept_id order by count(dept_id) desc limit 1)';
    ...
    public function Case5()
    {
        ...
        $sql = 'SELECT employees.name from employees inner join salary as s2019 on s2019.employee_id = employees.id and s2019.year = 2019 and s2019.deleted_at is null inner join salary as s2020 on s2020.employee_id = employees.id and s2020.year = 2020 and s2020.deleted_at is null order by s2020.amount - s2019.amount desc limit 1';
        $ret = $db->query($sql)->fetchColumn();
